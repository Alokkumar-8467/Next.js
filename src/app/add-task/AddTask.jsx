...
const AddTask = () => {
  ...
  const [task, setTask] = useState({
    ...
    userId : "65e9b2ef4ca45e12adf5cc74"
  });
  ...
  return (
    <div className=' grid grid-cols-12 justify-center'>
        <div className=' col-span-6 col-start-4 shadow-xl p-5'>
          <div className='my-2 flex justify-ceter'>
            <Image src={loginSvg} style={{width: "50%",alt:'Alok'}}
            alt='Alok' />
          </div>
          ...
          <form action="#!" onSubmit={handleAddTask}>
              ...
              <button className='bg-red-600 py-2 px-3 rounded-lg hover:bg-red-800 ms-3' >Clear Task</button>
              </div>
              {/* {
                JSON.stringify(task)
              } */}
